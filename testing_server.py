...
def makeWebhookResult(req):
    ...
    smartplug = {'실습지원 프린터': '000D6F00042D6FBB', '조명3': '000D6F0005287AD6'}

    url = 'http://165.194.38.49/rest/history?object=%s&endpoint=1&interval=day&offset=0' % (smartplug[name])
    r = requests.get(url, auth=HTTPDigestAuth('user_cauiacf', 'gomdingdaumnet'), verify=False, stream=True)
